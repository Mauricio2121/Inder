...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="20" align="left" valign="top"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="20" class="titulos"><!--DWLayoutEmptyCell-->&nbsp;</td>
      </tr>
      
      <tr>
        <td height="20" align="left" valign="top"><div align="justify">
          <p class="parrafo"><span class="titulosN"> DIRECTORIO DEL INDERSANTANDER 2017</span><br />
            <br />
        </p>
          <blockquote>
            <p class="parrafo"><strong>DESCARGUE AQU&Iacute; EL DIRECTORIO:</strong>            
              <a href="archivos/DirectorioTelefonico2018.pdf" target="_blank" class="gris" >Aquí</a><p class="parrafo"><br />
                <br />
                <br />
                <br />
              </blockquote>
