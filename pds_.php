    ...
    <td height="20" align="left" valign="top"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="20" align="left" valign="top"><div align="justify">
          <p class="parrafo">PLAN DE DESARROLLO SANTANDER EN SERIO EL<br />
            GOBIERNO DE LA GENTE 2012-2015<br />
            COMPONENTE PROGRAMATICO<br />
            LINEA ESTRATEGICA: SANTANDER HUMANO Y SOCIAL<br />
            SECTOR RECREACION Y DEPORTE</p>
          <p class="parrafo"><a href="institucional/pdsinder2012-2015.pdf" target="_blank" class="gris">Descargar Archivo </a></p>
        </div></td>
      </tr>
    </table></td>
