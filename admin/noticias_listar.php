...
<div id="formulario">
<a href="noticias_ingresar.php" target="_parent" title="Nueva noticia">NUEVA NOTICIA</a><br /><br />
...
<table id="tabla_listar">
    ...
    <?php
		...
		while($conexion_bd->recorrer_consulta_tabla($consultar_noticias)) {
			...
			echo '<tr style="font-size: 11px;"><td>'.$jpnot_titulo.'</td><td>'.$jpnot_fecha.'</td><td><a href="noticias_editar.php?id='.$jpnot_id.'" target="_parent"><img src="images/btn_editar.png" width="35" height="35" border="0" alt="Editar noticia" /></a>&nbsp;&nbsp;<a href="noticias_eliminar.php?id='.$jpnot_id.'" target="_parent"><img src="images/btn_eliminar.png" width="35" height="35" border="0" alt="Eliminar noticia" /></a></td></tr>';
			$i ++;
		}
	?>
    </table>
