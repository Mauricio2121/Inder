<?php	
	...
	//$campos_consulta = "";
	$condicion = "jpcom_id = $id";
	
	$consulta = "delete from jp_comentarios where $condicion";
	if(@$eliminar_usuarios = $conexion_bd->consultar_tabla($consulta, $link)) {
		//$mensaje .= '<img src="images/registro_eliminado.png" width="440" height="440" border="0" />';
		$mensaje .= "DATOS ELIMINADOS";
	}
	else {
		//$mensaje .= '<img src="images/registro_noeliminado.png" width="440" height="440" border="0" />';
